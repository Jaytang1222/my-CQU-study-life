...
#include "../../../../../../BNB_v3/QtGames/gameengine.h"
...
template <> constexpr inline auto GameEngine::qt_create_metaobjectdata<qt_meta_tag_ZN10GameEngineE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onBombExploded'
        QtMocHelpers::SlotData<void(Bomb *)>(3, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 4, 5 },
        }}),
    };
...
void GameEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onBombExploded((*reinterpret_cast<std::add_pointer_t<Bomb*>>(_a[1]))); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (GameEngine::*)()>(_a, &GameEngine::gameOver, 0))
            return;
    }
}
